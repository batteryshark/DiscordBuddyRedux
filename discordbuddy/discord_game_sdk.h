...
#define DISCORD_ACHIEVEMENT_MANAGER_VERSION 1
    ...
    enum EDiscordResult __declspec(dllexport) DiscordCreate(DiscordVersion version, struct DiscordCreateParams* params, struct IDiscordCore** result);
    ...
    struct DApplication {
        ...
        unsigned char fff[16];
        struct IDiscordUserManager* um;
    };
#ifdef __cplusplus
}
#endif
